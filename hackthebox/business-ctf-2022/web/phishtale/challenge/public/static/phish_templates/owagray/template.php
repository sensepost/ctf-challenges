...
<FORM name="logonForm" action="/" method="POST" autocomplete="off">
...
<DIV class="signInInputLabel" id="welcomeLabel" aria-hidden="true">Welcome to Outlook
...
<DIV tabindex="0" class="signinbutton" role="button"><IMG 
